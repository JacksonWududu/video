...
const buildArtifacts = ({episodeWorkspace, submissionPath, processedAt}) => {
  ...
  nextReview.rows = nextReview.rows.map((row) => {
    ...
    next.user_selection = {
      ...
      white_cat_visual_style_id: next.white_cat_visual_style_id ?? null,
      white_cat_visual_style_selection_sha256: next.white_cat_visual_style_selection_sha256 ?? null,
      visual_cohesion_profile_id: next.visual_cohesion_profile_id ?? null,
      comic_plan: null,
