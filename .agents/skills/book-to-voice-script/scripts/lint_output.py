#!/usr/bin/env python3
"""Lightweight lint for book-to-voice-script outputs."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Lint book-to-voice-script output.")
    ...
    print("book-to-voice-script lint passed")
    return 0
